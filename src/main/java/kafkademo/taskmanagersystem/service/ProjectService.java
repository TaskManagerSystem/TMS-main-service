...
public interface ProjectService {
    ...
    ProjectDto addMembers(User user, Long projectId, ProjectMembersUpdateDto updateDto);

    ProjectDto deleteMembers(User user, Long projectId, ProjectMembersUpdateDto updateDto);
}
